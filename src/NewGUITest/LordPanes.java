...
public class LordPanes {
	...
	public Panel nationPanel(Governments government,boolean b) {//creates the nation panel 
		...
		nation_panel.add(hex_prod = new JLabel("0"));
		...
		nation_panel.add(prov_inc = new JLabel("0"));
		...
		nation_panel.add(prov_upk = new JLabel("0"));
		...
		nation_panel.add(dev = new JLabel("0"));
		...
		nation_panel.add(ppop = new JLabel("0"));
		...
		nation_panel.add(vassal_tax_inc = new JLabel("0"));
		nation_panel.add(new JLabel("Guild Upkeep"));
		nation_panel.add(guild_upk = new JLabel("0"));
		nation_panel.add(new JLabel("Trade Income"));
		nation_panel.add(trade_inc = new JLabel("0"));
		nation_panel.add(new JLabel("Army Upkeep"));
		nation_panel.add(army_upk = new JLabel("0"));
		nation_panel.add(new JLabel("Government Upkeep"));
		nation_panel.add(gov_upk = new JLabel("0"));
		nation_panel.add(new JLabel("Trade Value"));
		nation_panel.add(trade_value = new JLabel("0"));
		nation_panel.add(new JLabel("Total Income"));
		nation_panel.add(tot_inc = new JLabel("0"));
		nation_panel.add(new JLabel("Total Upkeep"));
		nation_panel.add(tot_upk = new JLabel("0"));
		nation_panel.add(new JLabel("Total Production"));
		nation_panel.add(tot_prod = new JLabel("0"));
		nation_panel.add(new JLabel("Banked Development"));
		nation_panel.add(bank_dev = new JTextField("0"));
		nation_panel.add(new JLabel("Banked RP"));
		nation_panel.add(bank_rp = new JTextField("0"));
		nation_panel.add(new JLabel("Taxation Level"));
		nation_panel.add(tax_rate = new JTextField("0"));
		if (b) {
			nation_panel.add(new JLabel("Lord Tax Rate"));
			nation_panel.add(lord_tax_rate = new JTextField("0"));
		}
		return nation_panel;
	}
