...
public class NationHandler extends JFrame{
	...
	public static void loadNation (String s) {//only ever called from MainThread when an old nation is loaded
		...
		//JScrollPane hexpane = new JScrollPane(hexpanel.hexPane(),JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		mainPane.addTab("Hexes",hexpanel.hexPane());//loaded after all the lords
		...
		//mainPane.addTab("Notes", new JScrollPane(CommentsTab.init()));
